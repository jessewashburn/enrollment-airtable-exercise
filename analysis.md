...
The findings summarized below are based on stakeholder-facing Airtable views created within the shared base and are intended to be reviewed directly in Airtable.
...
- **Program Centers**:  
  - *Program Centers by Total Enrollment*  
...
Program-level analysis was used to identify where participation and follow-through are most concentrated across the organization.
...
Enrollments were also reviewed at the individual course level to identify which offerings are driving participation and strong completion.
